...
void integral_parallel(double xmin, double xmax, int n, int pid, int np);
...
int main(int argc, char **argv)
{
  ...
  integral_parallel(lowerLimit, upperLimit, numberRects, pid, np);
...
void integral_parallel(double xmin, double xmax, int n, int pid, int np)
{
  ...
  double integral = integral_serial(xminlocal, xmaxlocal, nlocal);
